...
from common.constants import DEFAULT_PORT, ACTION, TIME, \
...
def process_message(message, names, listen_socks):
    """ Функция отправки сообщения пользователю. Ничего не возвращает. """
    if message[DESTINATION] in names and names[message[DESTINATION]] in listen_socks:
        send_message(names[message[DESTINATION]], message)
        logger.info(f'Отправлено сообщение {message[DESTINATION]} от {message[SENDER]}.')
